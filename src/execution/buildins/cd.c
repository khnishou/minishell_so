...
/*   Updated: 2023/08/22 16:39:46 by ykerdel          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// static void	ft_cd_helper(char *cwd, t_data *g, int flag)
// {
// 	if (getcwd(cwd, sizeof(cwd)) != NULL)
// 			g->envp = update_envp(g->envp, cwd, g);
// 	if (g->envp == NULL)
// 	{
// 		g_exit_status = 1;
// 		if (flag)
...
// void	ft_cd(t_exe *exe, int flag, t_data *g)
// {
// 	char	cwd[1024];

// 	if (exe->cmd[1] == NULL)
// 	{
// 		chdir(ms_getenv("HOME", g));
// 		if (getcwd(cwd, sizeof(cwd)) != NULL)
// 			g->envp = update_envp(g->envp, cwd, g);
// 		g_exit_status = 0;
// 	}
